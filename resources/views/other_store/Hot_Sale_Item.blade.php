...
<style>
    .product-cart-wrap:hover {
        ...
        border: 1px solid #67bcee !important;
    }
</style>
<!--main area-->
<main class="main">
                        ...
                        <div class="col-lg-3 col-md-3 col-6 col-sm-6" style="padding: 10px 0px;">
                            <div class="product-cart-wrap small hover-up ">
                                <div class="product-img-action-wrap" style="padding: 0px 0px !important">
                                    <div class="product-img product-img-zoom">
                                        <a href="{{ route('Product_Details', ['category_name' => $prod->category->name,'auth_expired_key'=>'eyJhbGciOiJFZERTQSIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIxMjM0NTY3ODkwIiwibmFtZSI6IkpvaG4gRG9lIiwiYWRtaW4iOnRydWUsImlhdCI6MTUxNjIzOTAyMn0.JkKWCY39IdWEQttmdqR7VdsvT-_QxheW_eb0S5wr_j83ltux_JDUIXs7a3Dtn3xuqzuhetiuJrWIvy5TzimeCg',
                                ...
                                <div class="product-content-wrap" style="text-align: left;">
                                    <h2><a
                                            href="{{ route('Product_Details', ['product_name' => $prod->name,'category_name' => $prod->category->name,'auth_expired_key'=>'eyJhbGciOiJFZERTQSIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIxMjM0NTY3ODkwIiwibmFtZSI6IkpvaG4gRG9lIiwiYWRtaW4iOnRydWUsImlhdCI6MTUxNjIzOTAyMn0.JkKWCY39IdWEQttmdqR7VdsvT-_QxheW_eb0S5wr_j83ltux_JDUIXs7a3Dtn3xuqzuhetiuJrWIvy5TzimeCg',
                                        'category_id' => $prod->category->id,'product_id'=>$prod->id ]) }}">{{$prod['name']}}</a>
                                    </h2>
                                    @php
                                    // Example: $rating = 4.5;
                                    ...
                                    <div class="price-row">
                                        ...
                                        'product_id'=>$prod['id'] ]) }}"><i class="fi-rs-shopping-bag-add"></i></a>
                                        </div>
                                    </div>
                                </div>
                            </div>
