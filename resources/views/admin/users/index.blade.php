        ...
        <div class="row">
            <div class="col-12">
                ...
                <div class="card shadow-sm ">
                    ...
                    <div class="card-header bg-white border-bottom d-flex align-items-center">
                        ...
                        <div class="flex-grow-1">
                            <h3 class="card-title font-weight-bold mb-0">
                                <i class="fas fa-user mr-2 text-primary"></i> User Management
                            </h3>
                        </div>
                    ...
                    {{-- INLINE CREATE FORM --}}
                    <div class="card-body border-bottom bg-light" id="userCreateForm" style="
                                ...
                                <tbody>
                                    ...
                                    <tr id="row-{{ $user->id }}" data-role="{{ $user->role }}">
                                        ...
                                        <td>
                                            ...
                                            <span id="status-badge-{{ $user->id }}" class="view-mode badge px-3 py-2 rounded-pill
                                                        {{ $user->status == 'active'
                                                        ? 'badge-success'
                                                        : 'badge-danger' }}">
                                                {{ ucfirst($user->status) }}
